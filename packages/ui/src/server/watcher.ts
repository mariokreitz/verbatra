/**
 * The ui-owned live-refresh watcher (G14/G15): watches the source locale file, every configured
 ...
 * targets, lock) gets its own underlying {@link UiWatcher} instance and its own debounce timer, so
...
/**
 * Production {@link CreateUiWatcher}: wraps chokidar directly (a ui dependency in its own right,
 ...
 */
export const defaultCreateUiWatcher: CreateUiWatcher = (paths): UiWatcher => {
