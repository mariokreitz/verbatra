 ...
 * reachable when `createRpcHandlers` registered it, which requires both the `spend` and
 * `writeToDisk` capabilities. Params are always empty (`translation.translatePending` never takes
