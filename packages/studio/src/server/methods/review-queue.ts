 ...
 * dispatch registry regardless of `capabilities.spend`, matching the other unconditional read
 * handlers: the view half of the needs-review queue never calls a provider.
 */
