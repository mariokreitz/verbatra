 ...
 * not unit tested. The scope here is the pure helpers under `lib/` plus the few
 * components whose behavior is worth pinning, so the include globs are narrow and no
 * coverage threshold is declared.
 *
