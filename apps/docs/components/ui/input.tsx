...
/** Props for the docs Input; `prefix` renders a mono label ahead of the field. */
...
/** The design-system text input with an optional mono prefix and a focus ring on the wrapper. */
