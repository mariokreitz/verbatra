...
**Causa**: el `format` de la configuración no es uno de los siete ids de formato registrados. Esto
...
hay ninguna en marcha, borra el archivo de bloqueo en la ruta impresa y reintenta.
