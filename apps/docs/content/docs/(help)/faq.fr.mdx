...
`translate`, `watch` et `studio` chargent `.env` et `.env.local` depuis le répertoire de travail
(les vraies variables d'environnement gagnent). Le schéma de configuration rejette les clés
