...
| --- | --- | --- | --- |
| `version` | ja | - | die auszuführende `@verbatra/cli`-Version. Muss eine exakte Semver-Version wie `0.9.0` oder `0.9.1-next.0` sein; der Schritt schlägt sofort fehl bei einem Dist-Tag wie `latest`, einem Bereich oder einem `^`/`~`-Präfix |
