...
- [verbatra mit einem KI-Agenten einrichten](/docs/start-with-ai): ein copy-pasteable Prompt, der dieselben Befehle nutzt, um verbatra in ein bestehendes Projekt zu übernehmen, abgesichert durch eine menschliche Bestätigung.
