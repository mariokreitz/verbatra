...
Was eine Übersetzerin wissen muss, passt in drei Zeilen (und steht noch einmal auf dem Instructions-Blatt der Arbeitsmappe):
...
- Eine leere `Translation`-Zelle heißt "noch nicht übersetzt". Import überspringt sie und schreibt nie einen leeren String; eine halb ausgefüllte Arbeitsmappe kann also jetzt zurückkommen und der Rest später.
