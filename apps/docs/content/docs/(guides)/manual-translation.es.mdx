...
Lo que un traductor necesita saber cabe en tres líneas (y se repite en la propia hoja Instructions del libro):
...
- Una celda `Translation` vacía significa "todavía sin traducir". La importación la omite y nunca escribe una cadena vacía, así que un libro a medio rellenar puede volver ahora y el resto más tarde.
