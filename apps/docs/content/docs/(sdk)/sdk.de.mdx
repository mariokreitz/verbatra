...
existiert. Jede Prüfung läuft auch dann, wenn eine frühere fehlgeschlagen ist; ein Aufruf meldet
also jedes unabhängige Problem. Der API-Key wird nur über den Namen geprüft.
