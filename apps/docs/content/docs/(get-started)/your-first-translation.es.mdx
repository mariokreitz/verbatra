...
[`verbatra check`](/docs/cli/check) y [`verbatra diff`](/docs/cli/diff) también prescinden del proveedor: `check` informa de los recuentos por locale, `diff` lista las claves exactas.
