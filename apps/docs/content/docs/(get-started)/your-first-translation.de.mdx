...
[`verbatra check`](/docs/cli/check) und [`verbatra diff`](/docs/cli/diff) kommen genauso ohne Provider aus: `check` meldet Zählwerte pro Locale, `diff` listet die genauen Keys.
